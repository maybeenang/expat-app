...
import {getRl39, exportRL39} from '../services/rl39Service';
import {
  BottomSheetModal,
...
import {columns} from '../data/rl39Column';

const RL39Screen = ({navigation}) => {
  ...
  const [data, setData] = useState<RL39Item[] | null>(null);
