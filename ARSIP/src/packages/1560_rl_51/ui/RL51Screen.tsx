...
import {getRl51, exportRL51} from '../services/rl51Service';
import {
  BottomSheetModal,
...
import {columns} from '../data/rl51Column';
import {chartDataKeys} from '../data/rl51ChartDataKeys';

const RL51Screen = ({navigation}) => {
  ...
  const [data, setData] = useState<RL51Response | null>(null);
