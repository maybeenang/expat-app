...
import {getRl43, exportRL43} from '../services/rl43Service';
import {
  BottomSheetModal,
...
import {chartDataKeys} from '../data/rl43ChartDataKeys';
import {columns} from '../data/rl43Column';

const RL43Screen = ({navigation}) => {
  ...
  const [data, setData] = useState<RL43Response | null>(null);
