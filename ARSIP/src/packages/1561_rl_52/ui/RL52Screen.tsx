...
import {getRl52, exportRL52} from '../services/rl52Service';
import {
  BottomSheetModal,
...
import {RL52Response} from '../models/rl52Response';
...
import {columns} from '../data/rl52Column';
import {chartDataKeys} from '../data/rl52ChartDataKeys';

const RL52Screen = ({navigation}) => {
  ...
  const [data, setData] = useState<RL52Response | null>(null);
