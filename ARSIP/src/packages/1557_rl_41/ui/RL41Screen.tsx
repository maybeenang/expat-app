...
import {getRl41, exportRL41} from '../services/rl41Service';
import {
  BottomSheetModal,
...
import {columns} from '../data/rl41Column';
import {chartDataKeys} from '../data/rl41ChartDataKeys';

const RL41Screen = ({navigation}) => {
  ...
  const [data, setData] = useState<RL41Response | null>(null);
