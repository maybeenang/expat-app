...
import {getRl34, exportRL34} from '../services/rl34Service';
import {
  BottomSheetModal,
...
import {RL34DataGraphic, RL34Item} from '../models/rl34Response';
...
import {columns} from '../data/rl34Column';
import AppSwitch from '../../../components/AppSwitch';
import AppBarChart from '../../../components/AppBarChart';
import AppLineChart from '../../../components/AppLineChart';

const RL34Screen = ({navigation}) => {
  ...
  const [data, setData] = useState<RL34Item[] | null>(null);
  const [graphicData, setGraphicData] = useState<RL34DataGraphic[] | null>(
    null,
  );
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setGraphicData(result?.graphicsData ?? null);
      setLoading(false);
    };
        ...
        <SafeAreaView style={styles.container}>
          ...
          <ScrollView>
            <View style={styles.contentContainer}>
              ...
              {!loading && (data?.length ?? 0) > 0 && isShowGraphic && (
                <>
                  <AppBarChart
                    data={graphicData}
                    dataKey="pengunjung_baru"
                    label="Pengunjung Baru"
                  />
                  <AppBarChart
                    data={graphicData}
                    dataKey="pengunjung_lama"
                    label="Pengunjung Lama"
