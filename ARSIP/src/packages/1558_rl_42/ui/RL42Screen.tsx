...
import {getRl42, exportRL42} from '../services/rl42Service';
import {
  BottomSheetModal,
...
import {columns} from '../data/rl42Column';
import {chartDataKeys} from '../data/rl42ChartDataKeys';

const RL42Screen = ({navigation}) => {
  ...
  const [data, setData] = useState<RL42Response | null>(null);
