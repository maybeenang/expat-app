...
import {getRl311, exportRL311} from '../services/rl311Service';
import {
  BottomSheetModal,
...
import {columns} from '../data/rl311Column';

const RL311Screen = ({navigation}) => {
  ...
  const [data, setData] = useState<RL311Item[] | null>(null);
  ...
  const handleExport = async (type: ExportType) => {
    ...
    try {
      const result = await exportRL311(
        type,
        selectedFilterId,
        '0',
