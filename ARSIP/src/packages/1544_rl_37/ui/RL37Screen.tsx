...
import {getRl37, exportRL37} from '../services/rl37Service';
import {
  BottomSheetModal,
...
import {columns} from '../data/rl37Column';

const RL37Screen = ({navigation}) => {
  ...
  const [data, setData] = useState<RL37Item[] | null>(null);
