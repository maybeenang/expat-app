...
const reportData = [
  ...
  {id: '3', title: 'MKT 1421', subtitle: MODULES['1421_MKT_RANAP']},
  // {id: '4', title: 'MKT 1422', subtitle: MODULES['1422_MKT_ASAL_PASIEN']},
];

const LiveLaporanRsScreen = ({navigation}) => {
...
export default LiveLaporanRsScreen;
