...
import {getRl53, exportRL53} from '../services/rl53Service';
import {
  BottomSheetModal,
...
import {RL53Response} from '../models/rl53Response';
...
import {chartDataKeys} from '../data/rl53ChartDataKeys';
import {columns} from '../data/rl53Column';

const RL53Screen = ({navigation}) => {
  ...
  const [data, setData] = useState<RL53Response | null>(null);
