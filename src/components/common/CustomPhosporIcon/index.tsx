...
import BuildingApartment from 'phosphor-react-native/src/icons/BuildingApartment';
...
export const Icon: FC<IconProps> = ({
  ...
  const IconComponent = (SupportedIconsList[name] ??
    Question) as FC<PhosphorIconProps>;
